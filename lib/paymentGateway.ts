...
// Fallback static QRIS string template (EMVCo) used if GOPAY_STATIC_QRIS is not provided in env
const DEFAULT_FALLBACK_STATIC_QRIS = 
  "00020101021126590014ID.LINKAJA.WWW0118936009110021307842021008511977267151440014ID.GOPAY.WWW011893600911002130784202100851197726715204549953033605802ID5918CHERRY COFFEE ROAS6007BANDUNG61054011562070703A016304";
