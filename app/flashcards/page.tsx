        ...
        {deckCompleted ? (
          ...
          <div className="space-y-6">
            <div
              ...
              className="w-full min-h-[320px] sm:min-h-[360px] bg-white rounded-2xl border-2 border-paper-300 hover:border-paper-400 p-6 sm:p-10 shadow-card flex flex-col justify-between cursor-pointer transition-all hover:shadow-lg relative group"
            >
              {/* Card Top: Badges & Audio Pronounce */}
              ...
              <div className="py-6 my-auto text-center sm:text-left">
                {!isFlipped ? (
                      ...
                      <div className="mt-6 text-left" onClick={(e) => e.stopPropagation()}>
                        {!showHint ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-mono text-amber-800 hover:text-amber-950 bg-amber-50 hover:bg-amber-100 px-3 py-1.5 rounded-lg border border-amber-200 transition-colors"
                          >
                            <Lightbulb className="w-3.5 h-3.5 text-amber-600" />
                            <span>Buka Petunjuk (Hint)</span>
                          </button>
                        ) : (
                          <div className="p-3 bg-amber-50/90 rounded-lg border border-amber-200 text-xs text-amber-950 flex items-start gap-2">
                  ...
                  /* BACK: Answer & Scientific Details */
              ...
              {/* Card Bottom: Flip cue & shortcut helper */}
              <div className="border-t border-paper-200 pt-3 flex items-center justify-between text-[11px] font-mono text-roast-400">
                <span className="flex items-center gap-1.5 text-cherry-700 font-semibold group-hover:underline">
                  ...
                  {isFlipped ? 'Klik untuk kembali ke soal' : 'Klik kartu untuk melihat jawaban'}
                </span>
            ...
            {isFlipped ? (
              <div className="grid grid-cols-3 gap-3 animate-fadeIn">
                <button
                  ...
                  className="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-900 transition-all active:scale-95 shadow-xs"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-900 transition-all active:scale-95 shadow-xs"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-900 transition-all active:scale-95 shadow-xs"
                >
              ...
              <div className="flex items-center justify-between gap-4">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white hover:bg-paper-200 text-roast-700 border border-paper-300 font-mono text-xs uppercase font-bold tracking-wider disabled:opacity-40 disabled:pointer-events-none transition-colors"
                >
                ...
                <button
                  ...
                  className="flex-1 max-w-xs mx-auto py-2.5 rounded-lg bg-roast-950 hover:bg-cherry-900 text-paper-50 font-mono text-xs uppercase font-bold tracking-wider transition-all shadow-xs text-center"
                >
                  Buka Jawaban (Spasi)
                </button>
                ...
                <button
                  onClick={handleNext}
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white hover:bg-paper-200 text-roast-700 border border-paper-300 font-mono text-xs uppercase font-bold tracking-wider transition-colors"
                >
                  <span>Lewati</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </button>
